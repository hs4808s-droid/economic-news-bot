...
|------|--------|-----------|-----------|--------------|-----------|
| S&P500 선물 (ES) | 7,666.25 | +0.54% | 7,625 | 2026-09-15 20:29 | CBOE / CME (Yahoo chart API 자동수집) [P1] |
| 나스닥100 선물 (NQ) | 29,274.5 | +0.42% | 29,152.25 | 2026-09-15 20:29 | CBOE / CME (Yahoo chart API 자동수집) [P1] |
| 다우 선물 (YM) | 52,617 | +0.34% | 52,440 | 2026-09-15 20:28 | CBOE / CME (Yahoo chart API 자동수집) [P1] |
| 러셀2000 선물 (RTY) | 2,898.2 | +0.14% | 2,894.1 | 2026-09-15 20:29 | CBOE / CME (Yahoo chart API 자동수집) [P1] |
...
**매크로 (2026-09-15 20:29 ET 기준)**

| 항목 | 심볼 | 현재가/종가 | 전일 대비 | 직전 종가 | 출처+태그 |
|------|------|-------------|-----------|-----------|-----------|
| 미 10년 국채선물 | `ZN=F` | 106 | -0.40% | 106.42 | CME (Yahoo chart API 자동수집) [P1] |
| 금 | `GC=F` | 4,324.4 | -0.63% | 4,351.9 | COMEX (Yahoo chart API 자동수집) [P1] |
| WTI | `CL=F` | 104.84 | +3.40% | 101.39 | NYMEX (Yahoo chart API 자동수집) [P1] |
| 달러지수 (DXY) | `DX-Y.NYB` | 99.67 | +0.21% | 99.46 | ICE (Yahoo chart API 자동수집) [P1] |
...
- [1-A] ES선물 7,666.25(+0.54%), NQ선물 29,274.5(+0.42%), YM선물 52,617(+0.34%), RTY선물 2,898.2(+0.14%), 2026-09-15 20:28~29(ET) 기준 · CBOE/CME(Yahoo) [P1]
...
- [1-A] WTI 104.84(+3.40%) · 금 4,324.4(-0.63%) · DXY 99.67(+0.21%) · ZN 106(-0.40%), 2026-09-15 20:29(ET) 기준 · CBOE/CME(Yahoo) [P1]
